...
availabilities_4 = Availability.create!(user: herve, trip_availability: trip_availability_7)
availabilities_4 = Availability.create!(user: herve, trip_availability: trip_availability_9)
